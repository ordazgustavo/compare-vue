      ...
      <section class="section">
        <div class="container">
          <div class="columns pd is-desktop">
            ...
            <div class="column is-one-trird-desktop has text-centered">
            ...
            <div class="column">
              <div class="card">
                <div class="card-content">
                  <p class="title">"I think it's an absolutely excellent tool for our business. I cant survive without this thing."</p>
                  <p class="subtitle">- Gustavo Ordaz</p>
                </div>
              </div>
            </div>
            <div class="column">
